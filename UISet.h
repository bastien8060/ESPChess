...
void chess_homescreen() { //chess homescreen UI.
  ...
  tft.changeMode(TEXT);
  tft.setTextColor(RA8875_WHITE);
  tft.setCursor(630, 50);
  tft.print("Louis2014 - IE");

  tft.setCursor(510, 150);
  tft.print("Games");
  tft.setCursor(740, 150);
  tft.print("570");

  tft.setCursor(510, 175);
  tft.print("Puzzles");
  tft.setCursor(740, 175);
  tft.print("250");

  tft.setCursor(510, 225);
  tft.print("Bullet");
  tft.setCursor(740, 225);
  tft.print("526");
  
  tft.setCursor(510, 250);
  tft.print("Rapid");
  tft.setCursor(740, 250);
  tft.print("526");

  tft.setCursor(510, 275);
  tft.print("Puzzles");
  tft.setCursor(740, 275);
  tft.print("1023");

  tft.setCursor(510, 300);
  tft.print("Blitz");
  tft.setCursor(740, 300);
  tft.print("767");

  tft.setCursor(510, 325);
  tft.print("Puzzle Rush");
  tft.setCursor(740, 325);
  tft.print("19");
