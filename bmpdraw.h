...
bool bmpDraw(File bmpFile, int x, int y) {
...
void bmpDrawPath(char* path, int x, int y){


  Serial.printf("Opening image '%s' \n",path);

  File bmpFile;
  if ((bmpFile = SPIFFS.open(path, "r")) == NULL) {
