...
void chessboard() { //draw the chessboard
  ...
  delay(500);
  showfen("rnbqkbnr/pppp1ppp/8/4p3/4P3/8/PPPP1PPP/RNBQKBNR w KQkq e6 0 1", false); //TEST.
  delay(500);
  showfen("rnbqkbnr/pppp1ppp/8/4p3/3PP3/8/PPP2PPP/RNBQKBNR b KQkq - 0 1", false); //TEST.
  delay(500);
  showfen("rnbqkbnr/pppp1ppp/8/8/3pP3/8/PPP2PPP/RNBQKBNR w KQkq - 0 1", false); //TEST.
  delay(500);
  showfen("rnbqkbnr/pppp1ppp/8/8/3pP3/2P5/PP3PPP/RNBQKBNR b KQkq - 0 1", false); //TEST.
  delay(500);
  showfen("rnbqkbnr/pppp1ppp/8/8/4P3/2p5/PP3PPP/RNBQKBNR w KQkq - 0 1", false); //TEST.
  delay(500);
  showfen("rnbqkbnr/pppp1ppp/8/8/2B1P3/2p5/PP3PPP/RNBQK1NR b KQkq - 0 1", false); //TEST.
  delay(500);
  showfen("rnbqkbnr/pppp1ppp/8/8/2B1P3/8/Pp3PPP/RNBQK1NR w KQkq - 0 1", false); //TEST.
  delay(500);
  showfen("rnbqkbnr/pppp1ppp/8/8/2B1P3/8/PB3PPP/RN1QK1NR b KQkq - 0 1", false); //TEST.
  delay(500);
  showfen("rnbqk1nr/pppp1ppp/8/8/2B1P3/b7/PB3PPP/RN1QK1NR w KQkq - 0 1", false); //TEST.
  delay(500);
  showfen("rnbqk1nr/pppp1ppp/8/8/2B1P3/b4Q2/PB3PPP/RN2K1NR b KQkq - 0 1", false); //TEST.
  delay(500);
  showfen("rnbqk1nr/pppp1ppp/8/8/2B1P3/5Q2/Pb3PPP/RN2K1NR w KQkq - 0 1", false); //TEST.
  delay(100);
  showfen("rnbqk1nr/pppp1Qpp/8/8/2B1P3/8/Pb3PPP/RN2K1NR b KQkq - 0 1", false); //TEST.
